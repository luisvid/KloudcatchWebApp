...
Rails.application.config.sorcery.submodules = [:activity_logging, :http_basic_auth, :external, :remember_me, :reset_password]
...
Rails.application.config.sorcery.configure do |config|
  ...
  #
  config.controller_to_realm_map = {"application" => "KloudCatch"}
